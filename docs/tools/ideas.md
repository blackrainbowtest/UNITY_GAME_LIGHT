...
### Enemy exp and gold spawn count
- каждому врагу надо так же добавить уровень и ранг от до локация сама решает минимальный порог врага тоесть
если у врага стоит уровень от 1 до 10 а ранг от без ранга до C но в локации разрешени враги от 5 уровня до 25 а ранг
авантюбриста от F до A тогда уровень врага не может быть ниже 5 хотя у него прописано что может быть 1 и ранг
не может быть ниже F.

- Уроверь врага влияет на получаемое золото чем выше тем больше модификатор уровня но учитывается и уровень игрока тоесть если уровень
врага 10 а игрока 10 бонус к золоте небольшой а если у игрока 10 а врага 1 бонус даже отрицательный ну как в рпг играх