...
## Боёвка
- [Battle docs index](battle/INDEX.md)
- [Общее описание боевой системы](battle/BattleSystem_README.md)
- [Боёвка: TODO](battle/BATTLE_TODOS.md)
- [Legacy: Battle API Reference (monolith)](battle/BATTLE_API_REFERENCE.md)

### Участники
- [Player & Enemy API Reference](battle/Player_Enemy_API_REFERENCE.md)
- [NPCs](world/NPCs.md)
...
- [Recepies](tools/recepies.md)

## Документация внутри Assets
- [City Map README (в Assets)](../Assets/Scripts/City/CityMapREADME.md)
